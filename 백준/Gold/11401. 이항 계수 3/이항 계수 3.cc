...
using namespace std;
ll factorial[4000001];   // factorial 값을 저장할 배열
ll inverseFact[4000001]; // factorial의 역원을 저장할 배열
...
int main()
{
    ...
    inverseFact[4000000] = power(factorial[4000000], P - 2); // 페르마의 소정리를 이용하여 factorial[4000000]의 역원 구함
